...
export const CTAForm = () => {
  return (
    <div className="w-full max-w-[984px] text-white flex flex-col">
            ...
            <div className="w-full">
              <div className="flex flex-col tablet:flex-row items-start w-full">
                <input
                  ...
                  type="text"
                  className="outline-transparent flex leading-normal w-full rounded-md px-4 min-h-[48px] tablet:min-h-[56px] min-w-[16px] border border-gray-10 bg-gray-60"
                />
